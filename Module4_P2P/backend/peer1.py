...
# ---------------- CONFIG ----------------
HOST = "127.0.0.1"
TCP_PORT = 9001          # change for each peer
HTTP_PORT = 8084         # UI talks to this
PEER_NAME = "peer1"      # change to peer2, peer3, etc.
...
def upload_file():
    ...
    save_path = os.path.join(SHARED_DIR, file.filename)
    file.save(save_path)
